...
class SACAgent(Agent):
    ...
    def update(self, replay_buffer, logger, step, gw=False, normalize_reward=False, normalize_reward_batch=False, include_external_reward=False, weight_external_reward=1, weight_gw_reward=1):
